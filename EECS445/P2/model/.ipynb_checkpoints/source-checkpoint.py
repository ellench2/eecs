...
class Source(nn.Module):
    ...
    def init_weights(self):
        ...
        nn.init.normal_(self.fc1.weight, 0, 1 / sqrt(self.fc1.weight.size(1)))
    ...
    def forward(self, x):
        ...
        ##
        fcin1 = self.pool(nn.functional.relu(self.conv2(self.pool(nn.functional.relu(self.conv1(x))))))
        z = self.fc1(torch.flatten(nn.functional.relu(self.conv3(fcin1)), 1))
        return z
