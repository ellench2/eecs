...
void Triangle::read(istream& ins) {
   ...
   //     char c;
    ...
    //    ins >> c;
     ...
     //   cout << ":) " << vertexOne << "/" << vertexTwo << "/" << vertexThree << "/" << vertexOneColor << "/" << vertexTwoColor << "/" << vertexThreeColor;
        }
}
void Triangle::write(ostream& outs) {
    outs << vertexOne << " " << vertexOneColor << " " << vertexTwo << " " << vertexTwoColor << " " << vertexThree << " " << vertexThree;
}
