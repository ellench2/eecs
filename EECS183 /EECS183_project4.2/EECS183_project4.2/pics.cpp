...
void loadFile(Graphics& drawer)
{
    ...
    while (ins >> letter) {
        if (letter == 'L') {
     //       cout << "entered line conditional" << endl;
            Line lin;
            lin.read(ins);
            lin.draw(drawer);
        }
        else if (letter ==  'C') {
      //      cout << "entered circle conditional" << endl;
            Circle cir;
            cir.read(ins);
            cir.draw(drawer);
        }
        else if (letter ==  'T') {
      //      cout << "entered triangle conditional" << endl;
            Triangle tri;
            tri.read(ins);
            tri.draw(drawer);
        }
        else if (letter ==  'R') {
       //    cout << "entered rectangle conditional" << endl;
            Rectangle rec;
            rec.read(ins);
            rec.draw(drawer);
        }
            ...
            string rest;
            getline(ins, rest);
            cout << "Error in input file: " << letter << " " << rest << endl;
        }}
